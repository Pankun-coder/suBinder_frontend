    ...
    return (
        <div className="w-full text-center h-18">
            <section className="block">
                <input autoComplete="on" list= "student-list" onChange={(e) => {setUserInput(e.target.value)}} value={userInput} placeholder="生徒番号" className="border-2 border-black h-8 mt-1 w-96"></input>
